...
namespace jp.lilxyzw.lilycalinventory
{
    ...
    internal static class VRChatHelper
    {
        ...
        // 残りは全部Processorのみから使われる
        private static BuildContext ctx => Processor.ctx;
        ...
        internal static void Apply(InternalMenu rootMenu, List<InternalParameter> parameters)
        {
            ...
            ctx.AvatarDescriptor.expressionParameters = Cloner.CloneObject(ctx.AvatarDescriptor.expressionParameters, ctx, map) as VRCExpressionParameters;
