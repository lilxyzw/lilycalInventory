...
namespace jp.lilxyzw.lilycalinventory
{
    ...
    public class SemVerParser {
        ...
        {
            if(string.IsNullOrEmpty(prerelease) && string.IsNullOrEmpty(build)) return $"{major}.{minor}.{patch}";
            if(string.IsNullOrEmpty(build)) return $"{major}.{minor}.{patch}-{prerelease}";
            if(string.IsNullOrEmpty(prerelease)) return $"{major}.{minor}.{patch}+{build}";
